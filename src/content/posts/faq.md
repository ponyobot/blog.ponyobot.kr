...
- [Q 봇 명령어중 !ban 이라는 명령어가 있던데 이건 상대방을 정지시키거나 내보내는 명령어 아닌가요?](#q-봇-명령어중-ban-이라는-명령어가-있던데-이건-상대방을-정지시키거나-내보내는-명령어-아닌가요)
...
A : 포뇨봇은 해킹 목적의 봇이 아닙니다. 카카오톡 대화/관리 편의 기능을 제공하는 챗봇입니다.

---

### Q 봇 명령어중 !ban 이라는 명령어가 있던데 이건 상대방을 정지시키거나 내보내는 명령어 아닌가요?

A : `!ban`은 포뇨봇 명령어 사용만 제한하는 기능이며, 카카오톡 강퇴/정지 명령이 아닙니다. 또한 `!ban`/`!unban`은 관리자만 사용할 수 있습니다.
